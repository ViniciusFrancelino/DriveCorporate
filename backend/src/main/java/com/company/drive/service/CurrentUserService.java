...
@Service public class CurrentUserService {
 ...
 public User get(){Authentication a=SecurityContextHolder.getContext().getAuthentication(); if(a==null||!a.isAuthenticated()||"anonymousUser".equals(a.getName())) throw new ResourceNotFoundException("Usuário autenticado não encontrado"); return users.findByEmail(a.getName()).orElseThrow(()->new ResourceNotFoundException("Usuário autenticado não encontrado"));}
}
